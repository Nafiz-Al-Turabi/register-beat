        ...
        <>
            {
                user && user.planType !== "ultra" ? (
                    ...
                    songs?.message === "No beats found" ? (
                      <div className="text-center py-10">
                        <div className="p-6 bg-gradient-to-tl to-[#192332] via-[#22314b] from-[#141928] text-white rounded-lg mt-6 animate-from-middle relative z-0">
