  ...
  return (
    <div className='mx-2'>
        ...
        <div className='flex gap-4  border-b border-[#464646]'>
            <button className={`pb-2 px-4 ${settingActive ? 'border-b-2 border-[#9d00ff] text-[#9d00ff]' : ''}`} onClick={() => handleActive('settings')}>Settings</button>
            <button className={`pb-2 px-4 ${planActive ? 'border-b-2 border-[#9d00ff] text-[#9d00ff]' : ''}`} onClick={() => handleActive('plans')}>Plan & Billing</button>
        </div>
        <div className='p-4'>
            {settingActive && (
