        ...
        <div className="flex min-h-screen  text-white">
            ...
            <div className="flex-1 lg:ml-64 lg:z-50 ">
                <div className="flex items-center justify-between bg-[#0f0f0f] p-4 md:pl-8 sticky top-0">
                    ...
                    <Link to="/register-beat" className="flex items-center text-xs md:text-lg font-bold secondary-bg p-2 md:py-1.5 md:px-5 rounded-full hover:bg-violet-700 duration-300 active:scale-95 "><span className="hidden md:block">Register a Beat</span> 
