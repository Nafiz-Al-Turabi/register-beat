        ...
        <div>
            ...
            <div className='mt-6'>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="youtube-channel" className="block text-[#e3e6ed] text-sm font-medium mb-2">Youtube Channel</label>
                        <div className='flex justify-between items-center lg:w-1/2 p-2 bg-[#1e2837] text-white rounded-md border border-gray-600 focus:ring-1 focus:ring-purple-600'>
                            <input
                                type="text"
                                id="youtube-channel"
                    ...
                    <div>
                        <label htmlFor="new-password" className="block text-[#e3e6ed] text-sm font-medium mb-2">New Password</label>
                        <div className='flex justify-between items-center lg:w-1/2 p-2 bg-[#1e2837] text-white rounded-md border border-gray-600 focus:ring-1 focus:ring-purple-600'>
                            <input
                                type="password"
                                id="new-password"
                    ...
                    <button type="submit" className="bg-[#7031e6] text-base text-white font-bold p-3 mt-4 rounded-lg hover:bg-purple-700 duration-200 focus:outline-none">
                        Save
                    </button>
                </form>
            </div>
